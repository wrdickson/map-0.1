<div id = "baseMapToolbar" class="btn-group" role="group" aria-label="...">
  ...
  <div class="btn-group" role="group">
    ...
    <ul class="dropdown-menu">
      ...
      <li><a id="loadOpenTopo" href="">Open Topo Map</a></li>
  ...
  <div class="btn-group" role="group">
    ...
    <ul id = "userSelect" class="dropdown-menu">
        <% if( templateData.mUserId < 1 ) { %>
            <li><a id="map-login" href="">Login</a></li>
        <% }; %>
        <% if( templateData.mUserId > 0 ) { %>
            <li><a id="map-logoff" href="">Logoff</a></li>
        <% }; %>
        <% if( templateData.mUserId < 1 ) { %>
            <li id="map-registerLi"><a id="lmap-register" href="">Register</a></li>
        <% }; %>
